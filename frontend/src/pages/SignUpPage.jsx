    ...
    <div className="h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="forest">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm opacity-70">
                Join Speak and start your language learning journey today!
              </p>
            </div>
      ...
      <div className="max-w-md p-8">
        ...
        <div className="relative aspect-square max-w-sm mx-auto">
          <img src ="/signup-anime.png" alt = "language connection illustration" className="w-full h-full" />
        </div>

        <div className="text-center space-y-3 mt-6">
          <h2 className="text-xl font-semibold">Connect With Language partners worldwide</h2> 
          <p className="opacity-70">
            Practice Conversations, make friends and learn new languages
          </p>
